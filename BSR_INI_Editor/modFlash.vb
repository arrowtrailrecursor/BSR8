...
Module modFlash
    ...
    Public Function ReturnBSRPath() As String
        ...
        Do
            For Each Drive As DriveInfo In DriveInfo.GetDrives()
                ...
                If Label = "BSR_DRIVE" Or PathExists(Path & "\BSR_DIR\BSR_INI\BSR_CFG.INI", TypeOfPath.File) Then
                    Return Path.RSAtE("\")
                End If
            Next
        ...
        For Each Drive As DriveInfo In DriveInfo.GetDrives()
            If Drive.IsReady Then
                ...
                If Label = "U3 System" And Application.ExecutablePath.ToUpper Like Path.ToUpper & "*" Then
                    If PathExists(Path & "BSR_INI_Editor.exe", TypeOfPath.File) Then
                        Return True
                    End If
                End If
            End If
    ...
    Public Function ReturnU3Path() As String
        ...
        For Each Drive As DriveInfo In DriveInfo.GetDrives()
            Dim Label As String = Drive.VolumeLabel.ToString
            Dim Path As String = Drive.Name.ToString
            If Label = "U3 System" And PathExists(Path & "BSR_INI_Editor.exe", TypeOfPath.File) Then
                Return Path
                Exit Function
            End If
        Next
